jQuery(function(s) {
    var e = [
        ["#customize-theme-controls", "all", "ct-reset", "ct-reset-main", catch_shopCustomizerReset.confirm, catch_shopCustomizerReset.reset]
    ];
    s.each(e, function(e, o) {
        ...
        c.on("click", function(e) {
            ...
            var t = {
                wp_customize: "on",
                action: "catch_shop_customizer_reset",
                nonce: catch_shopCustomizerReset.nonce.reset,
                section: o[1]
            };
