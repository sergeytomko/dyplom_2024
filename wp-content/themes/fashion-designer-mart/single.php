...
<div id="content">
  ...
  <div class="container">
    <div class="row">
      <?php if(get_theme_mod('fashion_designer_mart_single_post_sidebar_layout', 'Right Sidebar') == 'Right Sidebar'){ ?>
      ...
      <?php } elseif(get_theme_mod('fashion_designer_mart_single_post_sidebar_layout', 'Right Sidebar') == 'Left Sidebar'){ ?>
      <div class="col-lg-4 col-md-4">
        <?php get_sidebar(); ?>
      </div>
      <div class="col-lg-8 col-md-8 mt-5">
