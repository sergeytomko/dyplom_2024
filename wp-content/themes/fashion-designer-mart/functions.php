...
if (!function_exists('fashion_designer_mart_loop_columns')) {
	function fashion_designer_mart_loop_columns() {
		$fashion_designer_mart_columns = get_theme_mod( 'fashion_designer_mart_per_columns', 3 );
		return $fashion_designer_mart_columns;
	}
}

//Change number of products that are displayed per page (shop page)
add_filter( 'loop_shop_per_page', 'fashion_designer_mart_per_page', 20 );
function fashion_designer_mart_per_page( $fashion_designer_mart_cols ) {
  	$fashion_designer_mart_cols = get_theme_mod( 'fashion_designer_mart_product_per_page', 9 );
	return $fashion_designer_mart_cols;
}

// Add filter to modify the number of related products
add_filter( 'woocommerce_output_related_products_args', 'fashion_designer_mart_products_args' );
function fashion_designer_mart_products_args( $args ) {
...
/*-----------------------------------------------------------------------------------*/
function fashion_designer_mart_global_color() {

    $fashion_designer_mart_theme_color_css = '';
    $fashion_designer_mart_copyright_bg = get_theme_mod('fashion_designer_mart_copyright_bg');

	$fashion_designer_mart_theme_color_css = '
	    .copyright {
				background: '.esc_attr($fashion_designer_mart_copyright_bg).';
			}
	';
    wp_add_inline_style( 'fashion-designer-mart-style',$fashion_designer_mart_theme_color_css );
    wp_add_inline_style( 'fashion-designer-mart-woocommerce-css',$fashion_designer_mart_theme_color_css );

}
add_action( 'wp_enqueue_scripts', 'fashion_designer_mart_global_color' );

add_action('after_switch_theme', 'fashion_designer_mart_setup_options');
function fashion_designer_mart_setup_options () {
