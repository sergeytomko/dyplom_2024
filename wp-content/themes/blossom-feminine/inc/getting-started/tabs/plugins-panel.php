...
<div id="plugins-panel" class="panel-left visible">
	...
	<p><?php printf( __( 'Below is a list of recommended plugins to install that will help you get the most out of %1$s. Although each plugin is optional, it is recommended that you at least install the BlossomThemes Toolkit, BlossomThemes Email Newsletter & Smash Balloon Social Photo Feed to create a website similar to the %1$s demo.', 'blossom-feminine' ), BLOSSOM_FEMININE_THEME_NAME ); ?></p>
